...
import { listAllUsers, deleteUser, updateUserRole, createUser, findUser, updateUserPassword } from '@/lib/db';
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const existing = await findUser(firstName, lastName, classCode);
    if (existing) {
